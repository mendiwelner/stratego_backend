...
Revision ID: baf68fbed6e9
Revises: 
Create Date: 2025-03-24 22:19:21.732823
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_users_setup'), 'users', ['setup'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_users_setup'), table_name='users')
